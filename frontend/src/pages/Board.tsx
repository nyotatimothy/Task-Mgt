...
export function Board() {
  ...
  return (
    <div style={{ padding: '20px' }}>
      ...
      {/* Filters */}
      <div style={{ display: 'flex', gap: '15px', marginBottom: '20px', padding: '15px', backgroundColor: '#f8f9fa', borderRadius: '4px' }}>
        <div>
          <label>Status: </label>
          <select 
            value={statusFilter} 
      ...
      {/* Board Columns */}
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '20px', height: 'calc(100vh - 250px)' }}>
        <div style={{ border: '1px solid #ddd', borderRadius: '4px', backgroundColor: '#f8f9fa' }}>
          <h3 style={{ padding: '15px', margin: 0, backgroundColor: '#e9ecef', borderRadius: '4px 4px 0 0' }}>
        ...
        <div style={{ border: '1px solid #ddd', borderRadius: '4px', backgroundColor: '#fff3cd' }}>
          <h3 style={{ padding: '15px', margin: 0, backgroundColor: '#ffeeba', borderRadius: '4px 4px 0 0' }}>
        ...
        <div style={{ border: '1px solid #ddd', borderRadius: '4px', backgroundColor: '#d4edda' }}>
          <h3 style={{ padding: '15px', margin: 0, backgroundColor: '#c3e6cb', borderRadius: '4px 4px 0 0' }}>
